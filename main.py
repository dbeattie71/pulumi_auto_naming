...
from auto.auto_naming import AutoNaming
from auto.naming.default_naming import DefaultNaming
...
auto_naming = AutoNaming(DefaultNaming(product_code="foo", static_environment_name="test"))
...
preview_res = stack.preview(on_output=print)
print(f"change summary: \n{json.dumps(preview_res.change_summary, indent=4)}")
